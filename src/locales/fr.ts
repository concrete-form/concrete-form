const translations = {
  ...
  'one-of': "ce champ doit contenir l'une des valeurs suivantes : {{values}}",
  'not-one-of': 'ce champ ne doit contenir aucune des valeurs suivantes : {{values}}',
  ...
  'more-than': 'ce champ doit être supérieur à {{more}}',
  ...
  'min-date': 'ce champ doit être ultérieur à {{min}}',
  'max-date': 'ce champ doit être antérieur à {{max}}',
  'min-items': 'ce champ doit contenir au moins {{min}} éléments',
  'max-items': 'ce champ ne doit pas contenir plus de {{max}} éléments',
}
